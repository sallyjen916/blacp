...
#RUN CONFIG
MAX_INSTS=1                      # Number of instructions to be simulated 1000000000
CHECKPOINT_CONFIG="multiprogram_8Gmem_10Bn"    # Name of directory inside CKPT_PATH
INST_TAKE_CHECKPOINT=1           # Instruction count after which checkpoint was taken
...
# Launch Gem5:
# change to ARM: $GEM5_PATH/build/X86/gem5.opt \
